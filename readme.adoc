...
. Download the .zip Otto libraries here link:{web-site}/largefileslarge/OttoDIYLib-master.zip[Download, window='_blank']
...
OTTO Arduino library: link:fileslarge/OttoDIYLib-master.zip[Download, window="_blank"]

OTTO BLockly program: link:fileslarge/OttoBlockly-Setup-1.4.4.exe[Download, window="_blank"]

Arduino V1.0 IDE: link:/fileslarge/arduino-1.8.19-windows.exe[Download, window="_blank"]
