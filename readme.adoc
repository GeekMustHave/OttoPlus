...
.Calibrate Otto
video::videos/Calibrate Otto.mp4.mp4[Calibrate Otto, width=640, height=480, start=0, end=999999, align='center']
...
[Source,bash]
----
image of BLOC script
----

This OTTO BLOC can be downloaded from this link:files/????.bloc[Link,window="_blank"]
