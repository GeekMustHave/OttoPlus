...
The video above can be viewed offline from this http://ftp.pwc-lms.com/BlogPosts/OttoPlus/videos/OttoDIY%20build%20Pt-2.mp4[Otto servo positioning]
...
If you are interest in the ASC Doctor (ADOC) markdown behind this document, it can be downloaded at this link:https://pwc-lms.com/OpenStuff/BlogPosts/OttoPlus/readme.adoc[Link]
