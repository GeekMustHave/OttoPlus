...
These two scripts are in the `Examples` image:xxyyzz-place-image-here.png[]
...
This OTTO BLOC can be downloaded from this link:htts://xxyyzz.com[Link,window="_blank"]
