...
This app has functions to do movements, play sounds and if an LED matrix attached show emoticons.


It is located in the Ardunio examples under OttoDIYLib/Bluetooth/Otto_PLUS_APP_V9.ino.

There is also a Blockly BLOC for testing the bluetooth.
