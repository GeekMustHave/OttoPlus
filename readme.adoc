...
The most current version of the Ardunio IDE as of this document date is 1.8.19 and can be downloaded from this link:{web-site}/files/arduino-1.8.19-windows.exe[Link, window='_blank']
